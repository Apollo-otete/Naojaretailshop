      ...
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4">
          <div className="h-9 flex items-center justify-between text-xs text-gray-500">
            ...
            <span className="hidden sm:block">Order before <strong className="text-gray-900">4:00pm</strong> for <strong className="text-gray-900">same-day delivery</strong> (Sun-Fri)</span>
            <span className="hidden md:block">Pickup: <strong className="text-gray-900">Kakamega (Lurambi, Opp. Bamboo)</strong> - Closed <strong className="text-gray-900 font-semibold text-red-600">Saturday</strong></span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="h-[72px] flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1.5 rounded-control hover:bg-surface transition-colors cursor-pointer"
                  ...
                  <div className="absolute top-full left-0 mt-2 w-72 bg-white border border-gray-200 rounded-card shadow-lg overflow-hidden z-50">
                      ...
                      {categories.map((cat) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {cat.description && (
                              <p className="text-xs text-gray-500 truncate text-[11px]">{cat.description}</p>
                            )}
                          </div>
                        </Link>
                      ))}
                    ...
                    <div className="border-t border-gray-200">
                      ...
                      <Link
                        to="/admin"
                        onClick={() => setCategoriesMenuOpen(false)}
                        className="flex items-center gap-2 px-4 py-3 text-sm text-gray-600 hover:bg-surface transition-colors border-t border-gray-100 font-semibold text-brand-600"
                      >
            ...
            <div className="flex-1 hidden md:flex items-center gap-2.5 border border-gray-200 rounded-control h-11 px-3">
              <Search className="w-4 h-4 text-gray-400 cursor-pointer" onClick={handleSearchSubmit} />
              <input
                type="text"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="md:hidden p-2.5 rounded-control hover:bg-surface transition-colors cursor-pointer"
        ...
        <div className="fixed inset-0 z-50 bg-white md:hidden overflow-y-auto">
          ...
          <div className="p-4">
            ...
            <div className="space-y-1">
              <p className="text-xs font-bold uppercase text-gray-400 px-2 mb-2">Categories</p>
              {categories.map((cat) => (
                <Link
                  key={cat.id}
                  to={`/category/${cat.slug}`}
                  className="block py-2 px-2 text-gray-700 hover:bg-surface rounded-control text-sm"
              ...
              <Link
                to="/admin"
                className="flex items-center gap-2 py-2 px-2 text-brand-600 font-semibold hover:bg-surface rounded-control text-sm"
                onClick={() => setMobileMenuOpen(false)}
              >
